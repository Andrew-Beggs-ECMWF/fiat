...
| delim ::= ',' | ' ' | '\t' | '/'
| option ::= <all> | <memory> | <heap> | <stack> | <rss> | <paging> | <walltime> | <cputime> | <count> | <memprof> | <cycles> | <cpuprof> | <trim> | <self> | <noself> | <noprop> | <nosize> | <cluster> | <callpath> | <papi> | <none>
| all ::= 'ALL'
| memory ::= 'MEM' | 'MEMORY'
| time ::= 'TIME' | 'TIMES'
| heap ::= 'HWM' | 'HEAP'
...
.. Used to toggle a slow region of code, which checks for the various system stats
...
.. table:: DR_HOOK_OPT Options
  ...
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | Flag     | Implements                                                                                             | Enables    | Comments                                                                                                                                                                                                                    |
  +==========+========================================================================================================+============+=============================================================================================================================================================================================================================+
  | all      | Nothing                                                                                                | * heap     | None                                                                                                                                                                                                                        |
  |          |                                                                                                        | * stack    |                                                                                                                                                                                                                             |
  |          |                                                                                                        | * rss      |                                                                                                                                                                                                                             |
  |          |                                                                                                        | * paging   |                                                                                                                                                                                                                             |
  |          |                                                                                                        | * walltime |                                                                                                                                                                                                                             |
  ...
  |          |                                                                                                        | * papi     |                                                                                                                                                                                                                             |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | memory   | Nothing                                                                                                | * heap     | None                                                                                                                                                                                                                        |
  |          |                                                                                                        | * stack    |                                                                                                                                                                                                                             |
  |          |                                                                                                        | * rss      |                                                                                                                                                                                                                             |
  |          |                                                                                                        | * count    |                                                                                                                                                                                                                             |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | times    | Nothing                                                                                                | * walltime | None                                                                                                                                                                                                                        |
  |          |                                                                                                        | * cputime  |                                                                                                                                                                                                                             |
  |          |                                                                                                        | * count    |                                                                                                                                                                                                                             |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | heap     | * Track and print current and max heap memory usage.                                                   | * count    | * Can also be enabled by :ref:`DR_HOOK_FUNCENTER <DR_HOOK_FUNCENTER>` or :ref:`DR_HOOK_FUNCEXIT <DR_HOOK_FUNCEXIT>` being enabled.                                                                                          |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | stack    | * Track and print current and max stack memory usage.                                                  | * count    | * Can also be enabled by :ref:`DR_HOOK_FUNCENTER <DR_HOOK_FUNCENTER>` or :ref:`DR_HOOK_FUNCEXIT <DR_HOOK_FUNCEXIT>` being enabled.                                                                                          |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | rss      | * Track and print current and max resident set size.                                                   | * count    | None                                                                                                                                                                                                                        |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | paging   | * Track and print current number of allocated pages.                                                   | * count    | None                                                                                                                                                                                                                        |
  |          | * Also tracks the maximum number of pages allocated per \drhook region.                                |            |                                                                                                                                                                                                                             |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | walltime | * Tracks total and per \drhook region walltime.                                                        | * count    | * ``walltime`` is measured in seconds.                                                                                                                                                                                      |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | cputime  | * Tracks total and per \drhook region cputime per process.                                             | * count    | * ``cputime`` is measured in CPU ticks.                                                                                                                                                                                     |
  |          |                                                                                                        |            | * Terminated child processes' time will also be included in this figure, i.e., multiprocessing will be reflected in the count.                                                                                              |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | count    | * Tracks the total number of \drhook regions entered (``calls``).                                      | Only self  | * \drhook uses ``status`` purely for tracking if it is currently in a region, and does not care about the depth.                                                                                                            |
  |          | * Also tracks how deep \drhook is in nested regions (``status``).                                      |            |                                                                                                                                                                                                                             |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | memprof  | * Unsure                                                                                               | * heap     | None                                                                                                                                                                                                                        |
  |          |                                                                                                        | * stack    |                                                                                                                                                                                                                             |
  |          |                                                                                                        | * rss      |                                                                                                                                                                                                                             |
  |          |                                                                                                        | * paging   |                                                                                                                                                                                                                             |
  |          |                                                                                                        | * count    |                                                                                                                                                                                                                             |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | cycles   | * Tracks CPU cycles (``cycles``).                                                                      | * walltime | * Adds printing functions to ``atexit()``.                                                                                                                                                                                  |
  |          | * Also tracks walltime (``wallprof``) for each \drhook region.                                         | * count    | * Disables cpuprof.                                                                                                                                                                                                         |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | cpuprof  | * Unsure                                                                                               | * cputime  | * Disables cycles.                                                                                                                                                                                                          |
  |          |                                                                                                        | * count    | * Also adds printing functions to ``atexit()``.                                                                                                                                                                             |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | trim     | * Trims \drhook region names to remove leading spaces and characters after the first subsequent space. | Only self  | None                                                                                                                                                                                                                        |
  |          |                                                                                                        |            |                                                                                                                                                                                                                             |
  |          |   * e.g. "  Hello World!" becomes "Hello".                                                             |            |                                                                                                                                                                                                                             |
  |          | * Also converts \drhook region names to upper case.                                                    |            |                                                                                                                                                                                                                             |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | self     | * Includes \drhook in profiling, also prints it.                                                       | Only self  | * Very expensive                                                                                                                                                                                                            |
  |          |                                                                                                        |            | * The default is to include \drhook in profiling, but doesn't print it.                                                                                                                                                     |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | noself   | * Excludes \drhook from profiling.                                                                     | Only self  | * The default is to include \drhook in profiling, but doesn't print it.                                                                                                                                                     |
  |          |                                                                                                        |            |                                                                                                                                                                                                                             |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | noprop   | * Does not propagate handled signals beyond \drhook.                                                   | Only self  | None                                                                                                                                                                                                                        |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | nosize   | * Unsure                                                                                               | Only self  | None                                                                                                                                                                                                                        |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | cluster  | * Prints cluster ID and size.                                                                          | Only self  | * Clusters together multiple runs of a \drhook region by different threads. This is purely for the user's readability. A more detailed description can be found in the output format for :ref:`profiling <Profiling_opt3>`. |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | callpath | * Tracks and outputs the callpath and depth of \drhook regions.                                        | Only self  | * Creates *much* more overhead.                                                                                                                                                                                             |
  |          |                                                                                                        |            | * Enables callpath mode and associated arguments. This will add additional columns to the output format for :ref:`profiling <Profiling_opt3>`.                                                                              |
  |          |                                                                                                        |            | * By default, this is in unrolled mode, which prints the callpath as an indented tree. This can be changed to packed mode by setting :ref:`DR_HOOK_CALLPATH_PACKED <DR_HOOK_CALLPATH_PACKED>`.                              |
  |          |                                                                                                        |            | * By default, this is to a max depth of 50, but can be changed by :ref:`DR_HOOK_CALLPATH_DEPTH <DR_HOOK_CALLPATH_DEPTH>`.                                                                                                   |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | papi     | * Enables PAPI mode                                                                                    | * cycles   | * Enables integrated PAPI instrumentation using \drhook regions. PAPI must be requested at compile time of \drhook using :ref:`ENABLEDR_HOOK_PAPI <ENABLEDR_HOOK_PAPI>` to enable this feature.                             |
  ...
  |          |                                                                                                        | * cycles   |                                                                                                                                                                                                                             |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
  | none     | Nothing                                                                                                | Nothing    | * Used to explicitly state there are no :ref:`DR_HOOK_OPT <DR_HOOK_OPT>` options. It is effectively ignored and does nothing.                                                                                               |
  +----------+--------------------------------------------------------------------------------------------------------+------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
This will add additional columns to the output format for :ref:`profiling <Profiling_opt3>`. The output callpath will be formatted as a single line, delimited by ``/``, compared to an indented tree of unrolled mode.
